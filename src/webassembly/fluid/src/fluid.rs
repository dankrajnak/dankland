...
impl FluidSimulation {
    pub fn new(particle_count: usize, width: usize, height: usize) -> FluidSimulation {
        ...
        FluidSimulation {
            ...
            interaction_radius: (height as f32 / 50.0) * 2.5 * 38.0
                / (particle_count as f32).sqrt(),
    ...
    pub fn old_x(&self) -> *const f32 {
        self.old_x.as_ptr()
    }

    pub fn old_y(&self) -> *const f32 {
        self.old_y.as_ptr()
    }

    pub fn vx(&self) -> *const f32 {
        self.vx.as_ptr()
    }

    pub fn vy(&self) -> *const f32 {
        self.vy.as_ptr()
    }
